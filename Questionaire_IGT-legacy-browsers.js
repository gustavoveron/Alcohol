...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'Alcohol_Form - AUDIT.csv', 'path': 'Alcohol_Form - AUDIT.csv'},
    {'name': 'Alcohol_Form - TAS-20.csv', 'path': 'Alcohol_Form - TAS-20.csv'},
    {'name': 'Alcohol_Form - BPQ-SF.csv', 'path': 'Alcohol_Form - BPQ-SF.csv'},
    {'name': 'Alcohol_Form - PACS.csv', 'path': 'Alcohol_Form - PACS.csv'},
...
function AUDIT_InstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    AUDIT_InstructionsComponents.forEach( function(thisComponent) {
...
function trials_AUDITLoopBegin(trials_AUDITLoopScheduler, snapshot) {
  return async function() {
    ...
    trials_AUDIT = new TrialHandler({
      ...
      trialList: 'Alcohol_Form - AUDIT.csv',
...
function trials_TAS_20LoopBegin(trials_TAS_20LoopScheduler, snapshot) {
  return async function() {
    ...
    trials_TAS_20 = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: 'Alcohol_Form - TAS-20.csv',
    ...
    // Schedule all the trials in the trialList:
    trials_TAS_20.forEach(function() {
...
function trials_BPQ_SFLoopBegin(trials_BPQ_SFLoopScheduler, snapshot) {
  return async function() {
    ...
    trials_BPQ_SF = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: 'Alcohol_Form - BPQ-SF.csv',
    ...
    // Schedule all the trials in the trialList:
    trials_BPQ_SF.forEach(function() {
...
function trials_PACSLoopBegin(trials_PACSLoopScheduler, snapshot) {
  return async function() {
    ...
    trials_PACS = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: 'Alcohol_Form - PACS.csv',
...
function AUDITRoutineBegin(snapshot) {
  return async function () {
    ...
    AUDITComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TAS_20_InstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    TAS_20_InstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TAS_20RoutineBegin(snapshot) {
  return async function () {
    ...
    TAS_20Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function BPQ_SF_InstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    BPQ_SF_InstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function BPQ_SFRoutineBegin(snapshot) {
  return async function () {
    ...
    BPQ_SFComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function PACS_InstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    PACS_InstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function PACSRoutineBegin(snapshot) {
  return async function () {
    ...
    PACSComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function IGT_InstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    IGT_InstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function finalMessageRoutineBegin(snapshot) {
  return async function () {
    ...
    finalMessageComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
